...
const contactInfo = graduates.map(function (arrItem){
...
*/
const lowPopulationAnimals = zooAnimals.filter(function (arrItem){
...
*/
const animalPop = zooAnimals.map(function (arrItem){
